...
const projectDirsWin: ProjectDirs = {
    cache: (project: ProjectOrString) =>
        envrel('LOCALAPPDATA', forceProjectToString(project), 'cache'),
    config: (project: ProjectOrString) =>
        envrel('APPDATA', forceProjectToString(project), 'config'),
    data: (project: ProjectOrString) =>
        envrel('APPDATA', forceProjectToString(project), 'data'),
    dataLocal: (project: ProjectOrString) =>
        envrel('LOCALAPPDATA', forceProjectToString(project), 'data'),
